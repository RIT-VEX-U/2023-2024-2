...
class IntakeSys : public StateMachine<IntakeSys, IntakeState, IntakeMessage, 5, false> {
public:
  ...
  IntakeSys(vex::distance &intake_watcher, vex::motor &intake_lower, vex::motor &intake_upper,
