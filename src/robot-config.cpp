...
MotionController::m_profile_cfg_t drive_mc_fast_cfg{.max_v = 55,  // Max 55 in/sec (at 100%)
...
MotionController::m_profile_cfg_t drive_mc_slow_cfg = {.max_v = 20,  // in/sec
                                                       .accel = 100, // in/sec^2
                                                       .pid_cfg = drive_mc_pid_cfg,
                                                       .ff_cfg = drive_mc_ff_cfg};
MotionController drive_mc_slow(drive_mc_slow_cfg);

MotionController::m_profile_cfg_t turn_mc_cfg{.max_v = 520, // 520 deg/sec max
...
robot_specs_t robot_cfg = {.robot_radius = 8,         // inches
...
CataSys cata_sys(intake_watcher, cata_pot, cata_watcher, cata_motors, intake_combine, intake_roller, cata_pid,
                 DropMode::Unnecessary);
